...
func main() {
	...
	yoloProcesser := postprocess.NewYOLOv8Pose(postprocess.YOLOv8PoseCOCOParams())
	...
	keyPoints := yoloProcesser.GetPoseEstimation(detectObjs)
...
func runBenchmark(rt *rknnlite.Runtime, yoloProcesser *postprocess.YOLOv8Pose,
	...
	for i := 0; i < count; i++ {
		...
		render.PoseKeyPoints(&srcImg, keyPoints, 2)
