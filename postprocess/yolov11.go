...
// YOLOv11 defines the struct for YOLOv11 model inference post processing
type YOLOv11 struct {
	// Params are the Model configuration parameters
	Params YOLOv11Params
	// nextID is a counter that increments and provides the next number
	// for each detection result ID
	idGen *idGenerator
}

// YOLOv11Params defines the struct containing the YOLOv11 parameters to use
// for post processing operations
type YOLOv11Params struct {
...
// YOLOv11DefaultParams returns an instance of YOLOv11Params configured with
// default values for a Model trained on the COCO dataset featuring:
// - Object Classes: 80
// - Box Threshold: 0.25
// - NMS Threshold: 0.45
// - Maximum Object Number: 64
func YOLOv11COCOParams() YOLOv11Params {
	return YOLOv11Params{
		BoxThreshold:    0.25,
		NMSThreshold:    0.45,
		ObjectClassNum:  80,
		ProbBoxSize:     85,
...
// NewYOLOv11 returns an instance of the YOLOv11 post processor
func NewYOLOv11(p YOLOv11Params) *YOLOv11 {
	return &YOLOv11{
		Params: p,
...
func (y *YOLOv11) processStride(boxTensor []int8, boxZP int32, boxScale float32,
